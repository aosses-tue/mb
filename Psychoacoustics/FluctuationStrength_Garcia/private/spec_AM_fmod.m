...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    stds(1).fm  = 4;    % fmod
    stds(1).fc  = 1000; % carrier frequency
    stds(1).md  = 40;   % modulation depth
    stds(1).SPL = 70;   % Sound pressure level
    stds(1).w   = 25;   %
    stds(1).fs  = 44100;% Sampling frequency
    ...
    spec.norm               = 83.6162;              % Normalisation factor???
    
    spec.plot.xlabel        = 'Modulation frequency [Hz]';
    spec.plot.x_handle      = @log2;                % Logarithmic x axis 
    spec.plot.dx            = 0.1;
