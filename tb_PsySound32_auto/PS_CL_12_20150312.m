function PS_CL_12_20150312(f1,f2)
% function PS_CL_12_20150312(f1,f2)
%
% 1. Description:
...
eval( sprintf('options.bDoAnalyser%s=1;',Num2str(12,2)) ); % activates selected processor
...
options.bLoudnessContrained = 1; % only validated for Analyser 12
...
labelParam1 = 'loudness';
labelParam2 = 'main-loudness';
labelParam3 = 'specific-loudness';
labelParam4 = 'average-main-loudness';
labelParam5 = 'average-specific-loudness';
labelParam6 = 'sharpness';
labelParam7 = 'loudness-fluctuation';

%% Plots
if nAnalyser ~= 21
    
    bPercentiles = 1; % only for loudness
