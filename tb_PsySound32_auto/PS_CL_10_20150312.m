function PS_CL_10_20150312(f1,f2)
% function PS_CL_10_20150312(f1,f2)
%
% 1. Description:
...
if nargin < 1
    f1 = '~/Documenten/Databases/dir01-Instruments/Voice-of-dragon/02-Wav-files/2015-02-wav-files/02-calibrated/meas-ac-2-close-ane.wav';
end
if nargin < 1
    f2 = '~/Documenten/Databases/dir01-Instruments/Voice-of-dragon/03-Wav-files-predicted/2015-02-wav-files/02-calibrated/model-ac-2-close-ane.wav';
end
...
eval( sprintf('options.bDoAnalyser%s=1;',Num2str(10,2)) ); % activates selected processor
...
options.frange   = [50  5000];
options.zrange   = [0.49392      18.5389];
options.trange   = [0  5];
...
labelParam1 = 'one-third-octave-band-spectrogram';
labelParam2 = 'one-third-octave-band-spectrum';
labelParam3 = 'specific-loudness';
labelParam4 = 'Param4';
labelParam5 = 'Param5';
labelParam6 = 'Param6';
labelParam7 = 'Param7';
