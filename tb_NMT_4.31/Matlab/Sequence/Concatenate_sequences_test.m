...
% Constant period & magnitude:
quc6.channels	= (1:6)';
quc6.magnitudes	= 60;
quc6.periods	= quc3.periods;
...
Tester(quc4, Concatenate_sequences( [], quc4 )		);
Tester(quc4, Concatenate_sequences({[], quc4})		);
Tester(quc3, Concatenate_sequences( quc3, [] )		);
Tester(quc3, Concatenate_sequences({quc3, []})		);
Tester(quc6, Concatenate_sequences( [], quc6, [] )	);
Tester(quc6, Concatenate_sequences({[], quc6, []})	);
...
quc15_.periods		= [quc1.periods;    repmat(quc5.periods,5,1)];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Concatenate two uniform-rate channel-magnitude sequences that have the same period:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Concatenate two uniform-rate channel-magnitude sequences that have different periods:
...
quc10_.periods		= [repmat(quc6.periods, 6, 1);
					   repmat(quc4.periods, 4, 1)];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Concatenate 3 uniform-rate channel-magnitude sequences, all same period:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Concatenate 4 uniform-rate channel-magnitude sequences, all same period:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Concatenate 4 uniform-rate channel-magnitude sequences that have different periods:
...
quc19_.periods	    = [repmat(quc6.periods, 6, 1);
					   repmat(quc3.periods, 3, 1);
					   repmat(quc4.periods, 4, 1);
					   repmat(quc6.periods, 6, 1)];
...
quf02_.phase_widths		=  quf1.phase_widths;
quf02_.phase_gaps		=  quf1.phase_gaps;
quf02_.periods			=  quf1.periods;
...
quf12_.phase_widths		=  quf6.phase_widths;
quf12_.phase_gaps		=  quf6.phase_gaps;
quf12_.periods			=  quf6.periods;
...
quf09_.phase_widths		= [repmat(quf6.phase_widths, 6, 1);
						   repmat(quf3.phase_widths, 3, 1)];
quf09_.phase_gaps		=  quf6.phase_gaps;
quf09_.periods			=  quf6.periods;
...
quf2000_.phase_widths	=  quf1.phase_widths;
quf2000_.phase_gaps		=  quf1.phase_gaps;
quf2000_.periods		=  quf1.periods;
...
quf6000_.phase_widths	=  quf6.phase_widths;
quf6000_.phase_gaps		=  quf6.phase_gaps;
quf6000_.periods		=  quf6.periods;
...
try
	...
	mismatch_seq = Concatenate_sequences(quc6, quf6);
	Tester(0);		% FAIL
catch
	Tester(1);
end
