function channel_bounds = FFT_filterbank_freq_bounds(weights, fft_length, audio_sample_rate)

% FFT_filterbank_freq_bounds: Calculate FFT filterbank frequency boundaries
%
% channel_bounds = FFT_filterbank_freq_bounds(weights, fft_length, audio_sample_rate)
%
