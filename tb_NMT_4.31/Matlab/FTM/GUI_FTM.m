function GUI_FTM(p, m, title_str)

% GUI_FTM: GUI to display a Frequency Time Matrix (FTM).
%
% GUI_FTM(p, m, title_str)
%
% p:             Parameter struct with the following fields:
% p.sample_rate:   Time axis sampling frequency.
% p.char_freqs:    Labels for frequency axis.
...
function Play_sound(u)
	...
	soundsc(u.audio{u.cell_index}, u.audio_sample_rate);
    Set_figure_data(u);
