...
display('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
display('Begin script "meas_20130125.m"')
display('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
...
FormatElectrodogram.Path = '/home/alejandro/Documenten/Meas/20130125_Cal_xPC_SP15/20130125-Cal_xPC_NIC_Recordings';
...
%     name1 = 'cal_55dB_20130125.out';
    name1 = ['cal_' num2str(i) 'dB_20130125.out'];

    % F0 Results:
    name2 = ['cal_' num2str(i) 'dB_F0_20130125.out'];
    ...
    MatrixMeanF0m(i)    = ( p{i}.pF0m.Energy( 1,7 ) )   ;
...
display('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
display('End script "meas_20130125.m"')
display('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')