...
seqACE      = read_aseq([directory 'Sequence-104Hz-JL-ACE-highest.aseq']);
...
[freq_warped, H_dB(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_ACE_110_Hz.wav');
[freq_warped, H_dB(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_ACE_117_Hz.wav');
[freq_warped, H_dB(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_ACE_124_Hz.wav');
[freq_warped, H_dB(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_ACE_131_Hz.wav');

[freq_warped, H_dB_F0m(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_F0m_104_Hz.wav');
[freq_warped, H_dB_F0m(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_F0m_110_Hz.wav');
[freq_warped, H_dB_F0m(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_F0m_117_Hz.wav');
[freq_warped, H_dB_F0m(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_F0m_124_Hz.wav');
[freq_warped, H_dB_F0m(:,end+1)] = ConvertFFT2FAT('PR_Stimuli-JL/UW_LB_F0m_131_Hz.wav');
