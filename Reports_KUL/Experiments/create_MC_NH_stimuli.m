function wavfilename = create_MC_NH_stimuli(ref_tone, conf, bGenerateTones, bLB, LB_Gains)
% function wavfilename = create_MC_NH_stimuli(ref_tone, conf, bGenerateTones, bLB, LB_Gains)
%
% Description:
...
%
%   Run create_APEX3_NH_all_experiments for an example about how to use this script.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
display(cd)
display([num2str(cont),' WAV-files',' at Fs = ',num2str(fs),' Hz. Duration of_',num2str(dur),' seconds'])
