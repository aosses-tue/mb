% MCI_Read_apexresult_Test_Inicial.m
%
...
nContours   = 9;
contours    = get_mci_contours(100); % Get the string-names for each contour
fontsize    = 10;
DirResults  = '/home/alejandro/Documenten/Meas/Meas/Experiments/Results_XML/AOV_2013_01_17/';

MCI_Group1_dir = {[DirResults 'MCI_AC_104_groep_1-results.apr'  ], ...
...
p           = MCI_Read_apexresult( MCI_Group1_dir );
means_f0m1  = p{1}.Mean;
