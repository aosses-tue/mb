...
for i = 1:length(f)
    ...
    Wavwrite(    y,fs,[outdir 'tone-' num2str(f(i)) 'Hz-Amp-100.wav']);
    Wavwrite(0.5*y,fs,[outdir 'tone-' num2str(f(i)) 'Hz-Amp-050.wav']);
    Wavwrite(0.1*y,fs,[outdir 'tone-' num2str(f(i)) 'Hz-Amp-010.wav']);
end
