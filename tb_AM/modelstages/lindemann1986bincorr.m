...
%
%   Input parameters:
%     insig      : signal with t x nfc x2 (right, left channel)
%     fs         : sampling rate
%
%   Output parameters:
...
%   output is a matrix of size n x m x amplitude, where
%   n = length(t)/fs.
%
...
%     
%
%   Url: http://amtoolbox.sourceforge.net/doc/modelstages/lindemann1986bincorr.php
