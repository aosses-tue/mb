...
%   Usage: Y = ffGn(N, tdres, Hinput) 
%          Y = ffGn(N, tdres, Hinput, noiseType, mu, sigma) 
%
%   Input parameters:
...
%
%  FFGN(...) returns a vector containing a sequence of fractional Gaussian 
...
%
%   FFGN accepts the following optional parameters:
%
...
%     
%
%   Url: http://amtoolbox.sourceforge.net/doc/modelstages/ffGn.php
