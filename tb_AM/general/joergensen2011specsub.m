...
%
%   Url: http://amtoolbox.sourceforge.net/doc/general/joergensen2011specsub.php
...
% 
output_Y=joergensen2011overlapadd3(Y_hat.^(1/2),YPhase,(W+padz),SP*W);
output_N=joergensen2011overlapadd3(PN_hat.^(1/2),Y_NPhase,(W+padz),SP*W);
