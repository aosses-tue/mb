...
%   See also: drnl
%
%   Url: http://amtoolbox.sourceforge.net/doc/demos/demo_drnl.php
...
signal_at_lvl1 = setdbspl(insig,lvl1); % added by AO
signal_at_lvl2 = setdbspl(insig,lvl2); % added by AO
signal_at_lvl3 = setdbspl(insig,lvl3); % added by AO

output.signal_at_lvl1 = signal_at_lvl1; % added by AO
output.signal_at_lvl2 = signal_at_lvl2; % added by AO
output.signal_at_lvl3 = signal_at_lvl3; % added by AO
output.lvl = [lvl1 lvl2 lvl3]; % added by AO
output.Fs = fs; % added by AO

[outsig1, fc1] = drnl(signal_at_lvl1, fs, 'bwmul',.1);
[outsig2, fc2] = drnl(signal_at_lvl2, fs, 'bwmul',.1);
[outsig3, fc3] = drnl(signal_at_lvl3, fs, 'bwmul',.1);
