function h = demo_absolutethreshold
% function h = demo_absolutethreshold
%
...
%
%   Url: http://amtoolbox.sourceforge.net/doc/demos/demo_absolutethreshold.php
...
legend(types); 
xlabel('Frequency (Hz)');  
ylabel('Absolute hearing threshold (dB re 20 \muPa)');
