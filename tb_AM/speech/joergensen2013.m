...
idx = find(isnan(x)); x(idx) = [];
idx = find(isnan(y)); y(idx) = [];
N = length(x);
...
% 1/4 of the centerfrequency of a given audio channel is used. (Verhey, Dau, and Kollmeier, 1999)
...
%
%
% Created by Soeren Joergensen jan 2010
% last update 07 mar 2014
% Copyright Soeren Joergensen
