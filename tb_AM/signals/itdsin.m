...
%ITDSIN Generate a one-second sinusoid with a interaural time difference
...
%
%   Url: http://amtoolbox.sourceforge.net/doc/signals/itdsin.php
%
% % Stand-alone example:
%       f   = 500; % [Hz]
%       Fs  = 44100;
...
%       xlabel('time [s]')
%       ylabel('Amplitude')
% % Comments by Alejandro Osses, HIT, TU/e, the Netherlands, 2014
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
