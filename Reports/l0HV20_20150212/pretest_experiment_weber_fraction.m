...
inter_set_interval = 3.0; % sec

nr_of_pairs = 5; % nr of pairs presented in one run
dB_range = 0; % range of intensities
dB_diff = [5 2 1];  % decreasing array of differences in dB SPL
...
output_filename = sprintf('weber_fraction_%s %s.txt', participant, tim);
