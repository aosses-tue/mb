function [outsig, fc, mfc, fs_intrep] = dau1997preproc_multi(insig, fs, fmin, fmax, varargin)
% function [outsig, fc, mfc, fs_intrep] = dau1997preproc_multi(insig, fs, fmin, fmax, varargin)
%
% 1. Description:
%       Auditory model from Dau et. al. 1997
%       Usage:  [outsig, fc] = dau1997preproc_multi(insig,fs);
%               [outsig, fc] = dau1997preproc_multi(insig,fs,...);
%
%   Input parameters:
