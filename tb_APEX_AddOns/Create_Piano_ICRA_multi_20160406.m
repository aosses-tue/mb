...
template_main           = [dir_main 'Templates' delim 'piano_multi_TEMPLATE.xml'];
template_1_proc         = [dir_main 'Templates' delim 'piano_multi_TEMPLATE_procedure.xml'];
template_2_datablocks   = [dir_main 'Templates' delim 'piano_multi_TEMPLATE_datablocks.xml'];
template_3_filters      = [dir_main 'Templates' delim 'piano_multi_TEMPLATE_filters.xml'];
template_4_stimuli      = [dir_main 'Templates' delim 'piano_multi_TEMPLATE_stimuli.xml'];
template_5_connections  = [dir_main 'Templates' delim 'piano_multi_TEMPLATE_connections.xml'];
template_6_cal          = [dir_main 'Templates' delim 'calibration-outs-only-L.xml'];
