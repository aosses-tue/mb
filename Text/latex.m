...
% function latex(matrix, filename, varargin)
% 
% You can call this function indirectly using GUI matrix2latex (just type
% matrix2latex in the MATLAB command line

% This software is published under the GNU GPL, by the free software
% foundation. For further reading see: http://www.gnu.org/licenses/licenses.html#GPL

% Usage:
% latex(matrix, filename, varargs)
% where
...
%   latex(matrix, 'out.tex', 'rowLabels', rowLabels, 'columnLabels', columnLabels, 'alignment', 'c', 'format', '%-6.2f', 'size', 'tiny'...
%                   , 'vlines', '1', hlines', '1');
%
% The resulting latex file can be included into any latex document by:
% /input{out.tex}
% 
% Programmed by : M. Koehler (koehler@in.tum.de)
% Created on    : 09/05/2004 (Version:  1.1)
% 
% Edited by Alejandro Osses, HTI, TU/e, the Netherlands, 2014
% Last edited on: 19/06/2014
% Last used on  : 19/06/2014
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
