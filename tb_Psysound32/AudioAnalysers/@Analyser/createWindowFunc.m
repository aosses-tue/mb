...
%
% 1. Description:
%       Returns a handle to the windowing function requested window functions 
%       are set for 0 dB gain (averaged over their duration) this is achieved 
%       with the coefficient at the end of each line
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
